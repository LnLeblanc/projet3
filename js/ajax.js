...
function ajaxGet(url, callback) {
    ...
    // Requête HTTP GET asynchrone vers le fichier langages.txt publié localement (la requête est asynchrone lorsque le 3ème paramètre vaut true ou est absent)
    req.open("GET", url);
